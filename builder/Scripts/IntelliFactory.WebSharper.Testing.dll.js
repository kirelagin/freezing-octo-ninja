(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Operators,Unchecked,JavaScript,ok,Testing,Pervasives,TestBuilder,test,Random,Arrays,Math,NaN1,Infinity1,List,String,Seq;
    ...
    Testing:{
     ...
     Random:{
      ...
      Natural:Runtime.Field(function()
      {
       ...
       return{
        Base:[0,1],
        Next:(f=function(value)
        {
         return Math.abs(value);
        },(g=Random.Int().Next,function(x)
        {
         return f(g(x));
        }))
       };
