    ...
    Base:{
     ...
     Tree:{
      ...
      Range:function(edit,input)
      {
       ...
       {
        var edit1,r,l,_,_1,_2,edit2,r1,l1,_3,tree,_4,_5,output;
        loop[1].$==1?(edit1=loop[1].$0,loop[2].$==2?(r=loop[2].$1,(l=loop[2].$0,(_=loop[3],(loop[3]=_,(loop[2]=l,(loop[1]=edit1,loop[0]=1)))))):(_1=loop[3],(_2=Runtime.New(_Tree_1,{
         $:0
        }),(loop[3]=_1,(loop[2]=_2,(loop[1]=edit1,loop[0]=1)))))):loop[1].$==2?(edit2=loop[1].$0,loop[2].$==2?(r1=loop[2].$1,(l1=loop[2].$0,(_3=loop[3]+Tree.Count(l1),(loop[3]=_3,(loop[2]=r1,(loop[1]=edit2,loop[0]=1)))))):(tree=loop[2],(_4=loop[3]+Tree.Count(tree),(_5=Runtime.New(_Tree_1,{
         $:0
        }),(loop[3]=_4,(loop[2]=_5,(loop[1]=edit2,loop[0]=1))))))):(output=loop[1].$0,(loop[0]=0,loop[1]=[loop[3],Tree.Count(loop[2])]));
       });
       return loop[1];
      },
