(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Collections,BalancedTree,Operators,List,T,Seq,Arrays,JavaScript,Enumerator,DictionaryUtil,Dictionary,Unchecked,_FSharpMap_2,_Pair_2,Option,MapUtil,_FSharpSet_1,SetModule,SetUtil,ResizeArray,_ResizeArrayProxy_1;
    ...
    Collections:{
     BalancedTree:{
      ...
      Lookup:function(k,t)
      {
       ...
       {
        var matchValue;
        t1[0]==null?loop[0]=false:(matchValue=Operators.Compare(k,t1[0].Node),matchValue===0?loop[0]=false:matchValue===1?(spine[0].unshift([true,t1[0].Node,t1[0].Left]),t1[0]=t1[0].Right):(spine[0].unshift([false,t1[0].Node,t1[0].Right]),t1[0]=t1[0].Left));
       });
       return[t1[0],spine[0]];
      },
      OfSeq:function(data)
      ...
      Rebuild:function(spine,t)
      {
       ...
       Runtime.For(0,spine.length-1,function(i)
       {
        ...
        t1[0]=(matchValue=spine[i],matchValue[0]?(x=matchValue[1],(l=matchValue[2],h(t1[0])>h(l)+1?h(t1[0].Left)===h(t1[0].Right)+1?(m=t1[0].Left,BalancedTree.Branch(m.Node,BalancedTree.Branch(x,l,m.Left),BalancedTree.Branch(t1[0].Node,m.Right,t1[0].Right))):BalancedTree.Branch(t1[0].Node,BalancedTree.Branch(x,l,t1[0].Left),t1[0].Right):BalancedTree.Branch(x,l,t1[0]))):(x1=matchValue[1],(r=matchValue[2],h(t1[0])>h(r)+1?h(t1[0].Right)===h(t1[0].Left)+1?(m1=t1[0].Right,BalancedTree.Branch(m1.Node,BalancedTree.Branch(t1[0].Node,t1[0].Left,m1.Left),BalancedTree.Branch(x1,m1.Right,r))):BalancedTree.Branch(t1[0].Node,t1[0].Left,BalancedTree.Branch(x1,t1[0].Right,r)):BalancedTree.Branch(x1,t1[0],r))));
       });
       return t1[0];
      },
     ...
     Dictionary:Runtime.Class({
      ...
      {
       var r;
       r=Runtime.New(this,Dictionary.New2());
       return r;
      },
      New4:function(capacity,comparer)
      {
       var r;
       r=Runtime.New(this,Dictionary.New12(comparer));
       return r;
      }
     }),
     DictionaryUtil:{
     ...
     "FSharpMap`2":Runtime.Class({
      ...
      {
       var r;
       r=Runtime.New(this,_FSharpMap_2.New1(MapUtil.fromSeq(s)));
       return r;
      },
      New1:function(tree)
      {
     ...
     "FSharpSet`1":Runtime.Class({
      ...
      {
       var r;
       r=Runtime.New(this,_FSharpSet_1.New1(SetUtil.ofSeq(s)));
       return r;
      },
      New1:function(tree)
      {
     ...
     ResizeArray:{
      "ResizeArrayProxy`1":Runtime.Class({
       Add:function(x)
       {
       ...
       {
        var x,f;
        x=ResizeArray.splice(this.arr,0,this.arr.length,[]);
        f=function(value)
        {
         value;
        };
       ...
       {
        return _ResizeArrayProxy_1.New3(Arrays.sub(this.arr,index,count));
       },
       Insert:function(index,items)
       {
        var x,f;
        x=ResizeArray.splice(this.arr,index,0,[items]);
        f=function(value)
        {
         value;
        };
       ...
       {
        var x,f;
        x=ResizeArray.splice(this.arr,index,0,Seq.toArray(items));
        f=function(value)
        {
         value;
        };
       ...
       {
        var x1,f;
        x1=ResizeArray.splice(this.arr,x,1,[]);
        f=function(value)
        {
         value;
        };
       ...
       {
        var x,f;
        x=ResizeArray.splice(this.arr,index,count,[]);
        f=function(value)
        {
         value;
        };
       ...
       {
        var r;
        r=Runtime.New(this,_ResizeArrayProxy_1.New3(Seq.toArray(el)));
        return r;
       },
       New1:function()
       {
        var r;
        r=Runtime.New(this,_ResizeArrayProxy_1.New3([]));
        return r;
       },
       New2:function()
       {
 ...
 Runtime.OnInit(function()
 {
  ...
  return _ResizeArrayProxy_1=Runtime.Safe(ResizeArray["ResizeArrayProxy`1"]);
 });
