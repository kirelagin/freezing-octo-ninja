   ...
   WebSharper:{
    Arrays:{
     ...
     choose:function(f,arr)
     {
      ...
      {
       var matchValue,x;
       matchValue=f(arr[i]),matchValue.$==0?null:(x=matchValue.$0,q.push(x));
      });
      return q;
     },
     ...
     reduce:function(f,arr)
     {
      ...
      Arrays.nonEmpty(arr);
      acc=[arr[0]];
      Runtime.For(1,arr.length-1,function(i)
      {
       acc[0]=(f(acc[0]))(arr[i]);
      });
      return acc[0];
    ...
    Concurrency:{
     ...
     Scheduler:Runtime.Class({
      ...
      tick:function()
      {
       ...
       {
        var tm,matchValue;
        tm=(new Date()).getTime()-t,tm>_this.MAX_TIME?(setTimeout(function()
        {
         return _this.tick();
        },0),loop[0]=false):(matchValue=_this.robin.length,matchValue===0?(_this.idle=true,loop[0]=false):(_this.robin.shift())(null));
       });
      }
     },{
      New:function()
    ...
    DateTime:Runtime.Class({
     ...
     {
      return DateTime.New3(this.get_Year(),this.get_Month()+months,this.get_Day(),this.get_Hour(),this.get_Minute(),this.get_Second(),this.get_Millisecond(),this.get_Kind());
     },
     ...
     {
      return DateTime.New3(this.get_Year()+years,this.get_Month(),this.get_Day(),this.get_Hour(),this.get_Minute(),this.get_Second(),this.get_Millisecond(),this.get_Kind());
     },
     Subtract:function(t)
     {
      return DateTime.New4(this.epoch-t,this.kind);
     ...
     get_Date:function()
     {
      return DateTime.New1(this.get_Year(),this.get_Month(),this.get_Day(),0,0,0);
     },
     get_Day:function()
     {
     ...
     {
      var r;
      r=Runtime.New(this,DateTime.New3(y,mo,d,0,0,0,0,0));
      return r;
     },
     New1:function(y,mo,d,h,m,s)
     {
      var r;
      r=Runtime.New(this,DateTime.New3(y,mo,d,h,m,s,0,0));
      return r;
     },
     New11:function(y,mo,d,h,m,s,ms)
     {
      var r;
      r=Runtime.New(this,DateTime.New3(y,mo,d,h,m,s,ms,0));
      return r;
     },
     New12:function(ticks)
     {
      var r;
      r=Runtime.New(this,DateTime.New21(ticks,0));
      return r;
     },
     New2:function(y,mo,d,h,m,s,k)
     {
      var r;
      r=Runtime.New(this,DateTime.New3(y,mo,d,h,m,s,0,k));
      return r;
     },
     New21:function(ticks,k)
     {
      var r;
      r=Runtime.New(this,DateTime.New4(ticks/10000>>0,k));
      return r;
     },
     New3:function(y,mo,d,h,m,s,ms,k)
     {
      var r;
      r=Runtime.New(this,DateTime.New4(((((function(arg20)
      {
     ...
     {
      var r;
      r=Runtime.New(this,DateTime.New(1,1,1));
      return r;
     },
    ...
    Json:{
     ...
     lookup:function(x)
     {
      ...
      {
       var n,rn;
       n=x[i[0]],(rn=r[0][n],!Unchecked.Equals(typeof rn,undefined)?(r[0]=rn,i[0]=i[0]+1):Operators.FailWith("Invalid server reply. Failed to find type: "+n));
      });
      return r[0];
     },
    ...
    Seq:{
     ...
     compareWith:function(f,s1,s2)
     {
      ...
      {
       var matchValue;
       matchValue=[e1.MoveNext(),e2.MoveNext()],matchValue[0]?matchValue[1]?r[0]=(f(e1.get_Current()))(e2.get_Current()):r[0]=1:matchValue[1]?r[0]=-1:loop[0]=false;
      });
      return r[0];
     },
     concat:function(ss)
        ...
        if(_enum.MoveNext())
         {
          ...
          {
           cur[0]=_enum.get_Current(),has[0]=check(cur[0]);
          });
          if(has[0])
           {
            return false;
     ...
     filter:function(f,s)
     {
      ...
      getEnumerator=function()
      {
       ...
       next=function(e)
       {
        ...
        {
         f(c[0])?(e.c=c[0],(res[0]=true,loop[0]=false)):_enum.MoveNext()?c[0]=_enum.get_Current():loop[0]=false;
        });
        return res[0];
       };
       return Enumerator.New(null,next);
     ...
     nth:function(index,s)
     {
      ...
      {
       !e.MoveNext()?Seq.insufficient():null,pos[0]=pos[0]+1;
      });
      return e.get_Current();
     },
     pairwise:function(s)
     ...
     toArray:function(s)
     {
      ...
      {
       var e;
       e=enumerator.get_Current(),q.push(e);
      });
      return q.slice(0);
     },
     toList:function(s)
     ...
     tryFindIndex:function(ok,s)
     {
      ...
      {
       var x;
       x=e.get_Current(),ok(x)?loop[0]=false:i[0]=i[0]+1;
      });
      if(loop[0])
       {
        return{
      ...
      if(a.length===b.length)
       {
        ...
        {
         !Unchecked.Equals(a[i[0]],b[i[0]])?eq[0]=false:null,i[0]=i[0]+1;
        });
        return eq[0];
       }
      else
      ...
      else
       {
        if(a.length>b.length)
        ...
        else
         {
          ...
          {
           cmp[0]=Unchecked.Compare(a[i[0]],b[i[0]]),i[0]=i[0]+1;
          });
          return cmp[0];
         }
       }
